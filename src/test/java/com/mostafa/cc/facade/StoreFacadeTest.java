...
public class StoreFacadeTest {
	...
	private static final StoreDTO STORE_BIRMINGHAM = new StoreDTO("a793f4a0-068c-45f4-8570-d172396621a2", "B24 9FP",
			"Birmingham", "Unit 11a The Fort Shipping Park, Fort Park Way", "28/06/1993", 8261);
	private static final StoreDTO STORE_GLASGOW = new StoreDTO("3fc8b9b0-f527-43d3-9628-5f0dde988986", "G53 6QR",
			"Glasgow", "Unit B8 Silverburn Shopping Centre", "02/06/1973", 15592);
	private static final StoreDTO STORE_LONDON = new StoreDTO("42fb44ca-ffb3-46b0-aeab-f6985c23a546", "BR1 1EA",
			"London", "12-14 High Street, Bromley", "19/05/1957", 21450);
	private static final StoreDTO STORE_SWANGE = new StoreDTO("e2b88cf1-508d-4def-a791-516fa4569fca", "BH19 2NT",
			"Swange", "High Street, The Trocadero", "04/11/1990", 9228);
	private static final StoreDTO STORE_WITHAM = new StoreDTO("a1fa2b11-7079-4230-a337-5bb043f78828", "CM8 2AQ",
			"Witham", "Units 20/22 Newlands Shopping Centre", "31/07/1971", 16264);
